...
export function Inspector({ session, onReset }: { session: Session; onReset: () => void }) {
  ...
  const stats: [string, string, string][] = [
    ...
    ['Tokens', compact(session.tokens.total), `${count(session.tokens.total)} total`],
    ['Output', compact(session.tokens.output), 'generated by the model'],
    ['Cache read', compact(session.tokens.cacheRead), `${pct(session.tokens.cacheRead, session.tokens.total)} of tokens`],
  ]
